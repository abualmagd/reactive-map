...
export default function EditSchool() {
  ...
  const showbigDialog = () => {
    document.getElementById("allModal").showModal();
  };
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="divider h-20 border-b-red-400"></div>
      <button
        onClick={showbigDialog}
...
const AreYouShureModalDeLeteAll = () => {
  const removeSk = async () => {
    try {
      ...
      closeDialog();
      notify(error + " خطأ في حذف الداتا", "error");
    }
  };

  const closeDialog = () => {
    document.getElementById("allModal").close();
  };
